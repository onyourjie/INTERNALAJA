// File: app/page.tsx (Updated with secure authentication)
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {error ? (
            ...
            /* Authenticated State - Show user info while redirecting */
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <button
                onClick={handleSignIn}
                className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
              >
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <p>• Gunakan email @student.ub.ac.id</p>
                  <p>• Hanya panitia terdaftar yang dapat mengakses</p>
                </div>
              </div>
            </div>
          )}
